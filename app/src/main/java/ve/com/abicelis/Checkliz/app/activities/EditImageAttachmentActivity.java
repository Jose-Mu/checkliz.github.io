...
import ve.com.abicelis.Checkliz.app.dialogs.SelectImageSourceDialogFragment;
...
import ve.com.abicelis.Checkliz.util.ImageUtil;
    ...
    public void onClick(View v) {
        ...
        switch (id) {
            case R.id.activity_edit_image_attachment_crop:
                applyPendingRotation();
                File imageFile = new File(FileUtil.getImageAttachmentDir(this), mImageAttachment.getImageFilename());
                Uri imageUri = FileProvider.getUriForFile(this, "ve.com.abicelis.Checkliz.fileprovider", imageFile);
    ...
    private void dispatchTakePictureIntent() {
        ...
        if (takePictureIntent.resolveActivity(this.getPackageManager()) != null) {
            ...
            if(imageAttachmentFile != null) {
                try {
                    imageUri = FileProvider.getUriForFile(this, "ve.com.abicelis.Checkliz.fileprovider", imageAttachmentFile);
